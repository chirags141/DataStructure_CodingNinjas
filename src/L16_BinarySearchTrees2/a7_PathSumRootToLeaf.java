...
5 7 1
 */
public class a7_PathSumRootToLeaf {
    public static void rootToLeafPathsSumToK(BinaryTreeNode<Integer> root, int k) {
        rootToLeafPathsSumToKHelper(root,k,"");
    }

    private static void rootToLeafPathsSumToKHelper(BinaryTreeNode<Integer> root, int k, String output) {
        ...
        rootToLeafPathsSumToKHelper(root.left,k-root.data,output);
        rootToLeafPathsSumToKHelper(root.right,k-root.data,output);
